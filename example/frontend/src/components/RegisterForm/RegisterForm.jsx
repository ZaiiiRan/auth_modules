    ...
    return (
        <form className={styles.form} onSubmit={submitForm}>
            ...
            <div className={styles.inputForm}>
                ...
                <input type="text" className={styles.input} placeholder="Введите Email" 
            ...
            <p className={styles.text}>Уже есть аккаунт? <Link to="/login" className={styles.link}>Войти</Link></p>
        </form>
    )
}